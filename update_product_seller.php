...
if(isset($_POST['submit'])){
    ...
    $sql1=mysqli_query($conn,"UPDATE product SET p_name='$name',p_price='$price',p_brand='$brand',p_discount='$discount',image='$image' WHERE p_id='$id'");
    if($sql1)
    {
        echo '<script> alert("updated sucessfully");window.location.href="view_product_seller.php";</script>';
    }
    else{
...
<!-- <div class="col-4 mt-5 bg-dark text-light p-5"> -->
                <form action=""method="POST" enctype="multipart/form-data">
                    ...
                    <input type="text" class="form-control" name="pname" value="<?php echo $row['p_name'];?>" required><br>
                    <label for="">Price</label>
                    <input type="text"class="form-control"name="pprice" value="<?php echo $row['p_price'];?>" required><br>
                    <label for="">Brand</label>
                    <input type="text"class="form-control"name="pbrand" value="<?php echo $row['p_brand'];?>"required><br>
                    <label for="">Discount</label>
                    <input type="discount"class="form-control"name="pdiscount" value="<?php echo $row['p_discount'];?>"required><br>
